"""
iTransformer Predictive Soft Sensor on EthyDistillation - Target Excluded.
...
def main():
    ...
    BasicTSLauncher.launch_training(BasicTSSoftSensorConfig(
        ...
        # Checkpoint
        ckpt_save_dir="checkpoints/EthyDistillation_benchmark/iTransformerForForecasting",
